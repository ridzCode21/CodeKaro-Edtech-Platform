...
import { studentEndpoints } from "../apiReq";
...
export async function buyCourse (token, courses, userDetails, navigate, dispatch) {
    ...
    toast.dismiss(toastId);
        ...
        console.log("buyCourse -> error", error.message)
    }
}
...
async function verifypament (bodyData,token,navigate,dispatch,) {
    const toastId = toast.loading("Please wait while we verify your payment");
    console.log("verifypayment -> courses", bodyData);
    try{
        // const data = {
